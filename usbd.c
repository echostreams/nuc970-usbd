...
/*__align(4)*/__attribute__((aligned(4))) static UINT16 _DeviceDescriptor[10] = {
    0x0112, 0x0200, 0x0000, 0x4000, 0x0416, 0x5963, 0x0100, 0x0201, 0x0100, 0x0000
};

/*__align(4)*/__attribute__((aligned(4))) static UINT16 _QualifierDescriptor[6] = {
    0x060a, 0x0200, 0x0000, 0x4000, 0x0001, 0x0000
};

/*__align(4)*/__attribute__((aligned(4))) static UINT16 _ConfigurationBlock[16] = {
    0x0209, 0x0020, 0x0101, 0xC000, 0x0932, 0x0004, 0x0200, 0x0000, 0x0000, 0x0507,
    0x0281, 0x0200, 0x0701, 0x0205, 0x0002, 0x0102
};

/*__align(4)*/__attribute__((aligned(4))) static UINT16 _ConfigurationBlockFull[16] = {
    0x0209, 0x0020, 0x0101, 0xc000, 0x0932, 0x0004, 0x0200, 0x0000, 0x0000, 0x0507,
    0x0281, 0x0040, 0x0701, 0x0205, 0x4002, 0x0100
};

/*__align(4)*/__attribute__((aligned(4))) static UINT16 _OSConfigurationBlock[16] = {
    0x0709, 0x0020, 0x0101, 0xc000, 0x0932, 0x0004, 0x0200, 0x0000, 0x0000, 0x0507,
    0x0281, 0x0040, 0x0701, 0x0205, 0x4002, 0x0100
};

/*__align(4)*/__attribute__((aligned(4))) static UINT16 _StringDescriptor0[2] = {
    0x0304, 0x0409
};

/*__align(4)*/__attribute__((aligned(4))) static UINT16 _StringDescriptor1[11] = {
    0x0316, 0x0055, 0x0053, 0x0042, 0x0020, 0x0044, 0x0065, 0x0076, 0x69, 0x0063, 0x0065
};

/*__align(4)*/__attribute__((aligned(4))) static UINT16 _StringDescriptor2[26] = {
